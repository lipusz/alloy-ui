		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-tree': {submodules: {'aui-tree-io': {skinnable:false, requires:['aui-io','json']}, 'aui-tree-view': {skinnable:true, requires:['aui-tree-node','aui-tree-paginator','aui-tree-io','dd-delegate','dd-proxy']}, 'aui-tree-paginator': {skinnable:false, requires:['aui-base']}, 'aui-tree-node': {skinnable:false, requires:['aui-tree-data','aui-tree-io','aui-tree-paginator','json','querystring-stringify']}, 'aui-tree-data': {skinnable:false, requires:['aui-base','aui-task-manager']} }, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-io', 'aui-tree-paginator', 'aui-tree-view'], skinnable:true},
